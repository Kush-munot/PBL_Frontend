...
const content = [
    ...
    {
        text: "Customizable Database",
        desc: "Tailor the database to suit your specific needs, with options to include additional information and customize fields according to your requirements.",
        animation: ""
    },
    {
